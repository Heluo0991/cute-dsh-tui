/**
 * cute-dsh-tui color themes — Gentle Mist Blue (雾蓝) family.
 *
 ...
 * theme from ~/.cute-dsh-tui/themes/<name>.json. Always resolvable to a concrete
 ...
 *
 * User themes (JSON files in ~/.cute-dsh-tui/themes/) overlay one of these three

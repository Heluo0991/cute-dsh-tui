...
const dict = {
  ...
  'doctor-launch-hint': { zh: '启动方式  cute-dsh-tui.cmd / dsh --profile cute-dsh-tui', en: 'Launch      cute-dsh-tui.cmd / dsh --profile cute-dsh-tui' },
  ...
  'login-logout-hint': { zh: 'DSH 凭证来自环境变量 DEEPSEEK_API_KEY — 删除该环境变量后重启 cute-dsh-tui 即登出', en: 'DSH credentials come from the DEEPSEEK_API_KEY env var — remove it and restart cute-dsh-tui to log out' },

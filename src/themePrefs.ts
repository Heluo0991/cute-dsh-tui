 ...
 * or user theme name) survives restarts in `~/.cute-dsh-tui/theme.json`, mirroring
 * the working-activity preference (`~/.cute-dsh-tui/working-activity.json`). The
 ...
 * when CUTE_DSH_TUI_THEME is unset — see ThemeProvider.
 */

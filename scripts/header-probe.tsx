...
console.log('--- opening: has mascot SGR truecolor?', /\x1b\[38;2;/.test(opening))
console.log('--- opening: has wordmark CuteDshTui?', openingPlain.includes('CuteDshTui'))
...
console.log('--- settled: has wordmark CuteDshTui?', full.includes('CuteDshTui'))
console.log('--- settled: has version?', full.includes('v1.1.0'))

 ...
 *
 * Creates a throwaway HOME with a fake ~/.cute-dsh-tui/themes directory containing
...
// their module-level dirs (~/.cute-dsh-tui, ~/.cute-dsh-tui/themes) resolve there.
...
const themesDir = join(tmpHome, '.cute-dsh-tui', 'themes')
...
check('themePrefs: corrupt file yields undefined, no throw', () => {
  writeFileSync(join(tmpHome, '.cute-dsh-tui', 'theme.json'), '{ nope ')

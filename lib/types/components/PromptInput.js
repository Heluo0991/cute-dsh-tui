 ...
 */
export function PromptInput({ channel, helpOpen, onToggleHelp, onRunCommand, selectionActive, fillText, onFillConsumed, onRewindRequest, onCyclePermission, controllerRef, modelSwitching = false, }) {

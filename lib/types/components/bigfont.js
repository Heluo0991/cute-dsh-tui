...
const MESSAGES_WHITE = { r: 255, g: 255, b: 255 };
const MESSAGES_GREY = { r: 170, g: 170, b: 170 };
const MESSAGES_DARK = { r: 85, g: 85, b: 85 };
const MESSAGES_CYAN = { r: 0, g: 170, b: 170 };
...
function bandStrength(position, center, radius) {
 ...
 */
function messagesShimmerStrength(x, row, width, time) {
...
export function renderMessagesText(text, time, from, to, flash, stepMs = 60) {
    const source = MESSAGES_RENDERED[text];
    if (source === undefined)
        return renderBigText(text, time, from, to, flash, stepMs);

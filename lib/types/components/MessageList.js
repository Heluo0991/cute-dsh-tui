...
function TranscriptRow({ rowId, kind, label, text, streaming, durationMs, time, addMargin, isSelected, isExpanded, expanded, model, background, toolCallId, toolName, toolArgsText, toolArgsFull, toolStatus, toolResultText, toolResultFull, toolErrorText, toolCallView, toolResultView, toolStartedAt, toolDurationMs, onToggleRow, setRowRef, }) {
    ...
    switch (kind) {
        ...
        case 'context':
            return (_jsx(Box, { marginTop: addMargin ? 1 : 0, paddingLeft: 2, backgroundColor: background, ref: ref, onClick: onClick, children: expanded || isExpanded ? (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "permission", bold: true, children: ["\u2301 ", label ?? 'Injected context'] }), _jsx(Text, { dimColor: true, wrap: "wrap", children: text })] })) : (_jsxs(Text, { dimColor: true, italic: true, children: ["\u2301 ", label ?? 'Injected context', " \u2014 ", compactPreview(text), ' ', _jsx(KeyboardShortcutHint, { shortcut: "ctrl+o", action: "expand", parens: true })] })) }));
        case 'assistant':

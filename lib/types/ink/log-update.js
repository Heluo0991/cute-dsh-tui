    ...
    render(prev, next, altScreen = false, decstbmSafe = true) {
        ...
        if (shrinking) {
            ...
            if (!altScreen && prev.screen.height > prev.viewport.height) {
                logForDebugging(`Viewport repaint (shrink tall): prevHeight=${prev.screen.height}, nextHeight=${next.screen.height}, viewport=${prev.viewport.height}, cursorAtBottom=${cursorAtBottom}`);

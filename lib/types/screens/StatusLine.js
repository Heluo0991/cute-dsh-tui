...
function permissionLevel(current) {
    switch (current) {
 ...
 */
export function StatusLine({ channel, selectionActive = false, helpOpen = false, btwUnseen = 0, btwViewActive = false, }) {
    ...
    if (usage !== undefined && usage.cacheRead > 0) {
        ...
        contextParts.push(_jsxs(Text, { children: [_jsxs(Text, { dimColor: true, children: [t('status-cache-label'), " "] }), _jsxs(Text, { color: "inactiveShimmer", children: [rate.toFixed(1), "%"] })] }, "cache"));
    }
    ...
    const leftParts = [
        _jsx(Text, { color: "claude", children: "CuteDshTui" }, "brand"),
        _jsx(Text, { color: "inactiveShimmer", children: channel.model }, "model"),
        ...(channel.agentPreset !== undefined
            ? [
                _jsx(Text, { color: "professionalBlue", children: channel.agentPreset }, "mode"),
            ]
            : []),
        ...(permission !== undefined
            ? [
                _jsx(Text, { color: permission === 'fullaccess'
                        ? 'warning'
                        : permission === 'workspace'
                            ? 'success'
                            : undefined, dimColor: permission === 'readonly', children: permission }, "permission"),
            ]
            : []),
        ...tpsParts,
        ...contextParts,
        ...
        ...(btwUnseen > 0
            ? [
                _jsx(Text, { color: "remember", children: t('btw-done-badge', { n: String(btwUnseen) }) }, "btw"),
            ]
            : []),
    ];
